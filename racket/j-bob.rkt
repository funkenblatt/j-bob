...
(require (submod "j-bob-lang.rkt" j-bob-support))
(require (submod "j-bob-lang.rkt" j-bob-macros))
...
(defun axioms ()
  '((dethm atom/cons (x y)
    ...
    (dethm atom-empty () (equal (atom '()) 't))
    (dethm atom-true (x) (if (atom x)
                             (equal (atom x) 't)
                             't))

    (dethm atom-nil (x) (if (atom x)
                            't
                            (equal (atom x) 'nil)))))
